...
def black_litterman_portfolio(coint_start_day, coint_end_day, df_ret,folder_path1,folder_path2,t1,t2,t3,t4,t5,t6):
    ...
    while end_day_index < num:
        ...
        Q1 = pd.read_csv(csv_file_path1)["diff Bootstrap Mean"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        cov_matrix = ret_subset.cov()
        csv_file_path1 = os.path.join(folder_path1, f"output_{iteration_count}.csv")
        Q2 = pd.read_csv(csv_file_path1)["diff Monte Carlo Simulation"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        Q3 = pd.read_csv(csv_file_path1)["ols Bootstrap Mean"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        cov_matrix = ret_subset.cov()
        csv_file_path1 = os.path.join(folder_path1, f"output_{iteration_count}.csv")
        Q4 = pd.read_csv(csv_file_path1)["ols Monte Carlo Simulation"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        cov_matrix = ret_subset.cov()
        csv_file_path1 = os.path.join(folder_path1, f"output_{iteration_count}.csv")
        Q5 = pd.read_csv(csv_file_path1)["kf Bootstrap Mean"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        cov_matrix = ret_subset.cov()
        csv_file_path1 = os.path.join(folder_path1, f"output_{iteration_count}.csv")
        Q6 = pd.read_csv(csv_file_path1)["kf Monte Carlo Simulation"]
    ...
    #df_ret2.iloc[44,:]*normalized_weights.T
        ...
        new_data = {'Iteration': iteration_count,
                    'diff Bootstrap Mean': portfolio_value1,
                    'diff Monte Carlo Simulation': portfolio_value2,
                    'ols Bootstrap Mean': portfolio_value3,
                    'ols Monte Carlo Simulation': portfolio_value4,
                    'kf Bootstrap Mean': portfolio_value5,
                    'kf Monte Carlo Simulation': portfolio_value6}
